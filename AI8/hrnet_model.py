...
Based on HRNet-W18-C-Small-v2 for facial keypoints detection
"""
...
def get_pose_net(cfg, is_train, **kwargs):
    """Get HRNet pose estimation model"""
    model = PoseHighResolutionNet(cfg, **kwargs)

    if is_train and cfg.get('PRETRAINED'):
        model.init_weights(cfg['PRETRAINED'])

    return model


# HRNet-W18-C-Small-v2 configuration for facial keypoints
hrnet_w18_small_config = {
    'NUM_JOINTS': 14,
    'PRETRAINED_LAYERS': ['*'],
    'FINAL_CONV_KERNEL': 1,
    'STAGE2': {
